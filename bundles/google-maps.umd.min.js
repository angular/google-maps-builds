...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var L,k=[c,l,y,d,_,m,f,v,M,O,z,w,I];(L=function L(){}).decorators=[{type:e.NgModule,args:[{declarations:k,exports:k}]}],
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     ...
     * found in the LICENSE file at https://angular.io/license
     */
t.GoogleMap=c,t.GoogleMapsModule=L,t.MapBaseLayer=l,t.MapBicyclingLayer=y,t.MapCircle=d,t.MapGroundOverlay=_,t.MapInfoWindow=m,t.MapKmlLayer=f,t.MapMarker=v,t.MapPolygon=M,t.MapPolyline=O,t.MapRectangle=z,t.MapTrafficLayer=w,t.MapTransitLayer=I,Object.defineProperty(t,"__esModule",{value:!0})}));